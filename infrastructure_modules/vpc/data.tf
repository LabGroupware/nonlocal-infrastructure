locals {
  ...
  ## Public SG ##
  public_security_group_name        = "scg-${var.name}-${var.region_tag[var.region]}-${var.env}-public"
  ...
  public_bastion_security_group_name        = "scg-${var.name}-${var.region_tag[var.region]}-${var.env}-bastion"
  public_bastion_security_group_description = "Security group for public bastion subnets"
  public_bastion_security_group_tags = merge(
    var.tags,
    tomap({
  ...
  ## Private SG ##
  private_security_group_name        = "scg-${var.name}-${var.region_tag[var.region]}-${var.env}-private"
  ...
  ## DB SG ##
  db_security_group_name        = "scg-${var.name}-${var.region_tag[var.region]}-${var.env}-database"
